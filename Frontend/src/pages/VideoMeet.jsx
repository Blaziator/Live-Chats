                ...
                <div className={styles.meetVideoContainer}>
                    ...
                    {showModal ?<div className={styles.chatRoom}>
                        ...
                        <div className={styles.chatContainer}>
                            ...
                            <TextField value={message} onChange={e => setMessage(e.target.value)} id="standard-basic" label="Type your message here" variant="standard" />
                    ...
                    <div className={styles.buttonContainer}>
                        ...
                        <video className={styles.meetUserMedia} ref={localVideoRef} autoPlay muted></video>
